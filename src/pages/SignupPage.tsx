...
const roles = ["Homeowner", "Service Provider", "Property Consultant"];
        ...
        <div className="w-full max-w-md animate-scale-in">
          <div className="glass-card rounded-2xl p-8">
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">Join PropValue+ and start adding value</p>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative mt-1.5">
                  ...
                  <Input id="name" placeholder="John Doe" className="pl-10 rounded-xl" />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="relative mt-1.5">
                  ...
                  <Input id="phone" placeholder="+91 98765 43210" className="pl-10 rounded-xl" />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="relative mt-1.5">
                  <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                  <Input id="confirmPassword" type="password" placeholder="••••••••" className="pl-10 rounded-xl" />
                </div>
              </div>
